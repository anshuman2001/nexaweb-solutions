...
const productsListSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4,  item: { '@type': 'SoftwareApplication', name: 'Internship Certificate Generator', applicationCategory: 'BusinessApplication',   url: `${siteUrl}/certificates` } },
    { '@type': 'ListItem', position: 5,  item: { '@type': 'SoftwareApplication', name: 'Cold Email AI Agent',             applicationCategory: 'BusinessApplication',    url: `${siteUrl}/cold-email-agent` } },
    { '@type': 'ListItem', position: 6,  item: { '@type': 'SoftwareApplication', name: 'AI Calling Agent',                applicationCategory: 'BusinessApplication',    url: `${siteUrl}/ai-calling-agent` } },
    { '@type': 'ListItem', position: 7,  item: { '@type': 'SoftwareApplication', name: 'eCommerce Shopping Agent',        applicationCategory: 'ShoppingApplication',    url: `${siteUrl}/ecommerce-agent` } },
    { '@type': 'ListItem', position: 8,  item: { '@type': 'SoftwareApplication', name: 'Interior AI Designer',            applicationCategory: 'DesignApplication',      url: `${siteUrl}/interior-ai` } },
    { '@type': 'ListItem', position: 9,  item: { '@type': 'SoftwareApplication', name: 'EduAccess AI',                    applicationCategory: 'EducationalApplication', url: `${siteUrl}/eduaccess-ai` } },
    { '@type': 'ListItem', position: 10, item: { '@type': 'SoftwareApplication', name: 'DigiAgentix Content Agent',       applicationCategory: 'BusinessApplication',    url: `${siteUrl}/content-agent` } },
  ],
};
