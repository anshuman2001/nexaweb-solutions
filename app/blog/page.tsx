...
export const metadata: Metadata = {
  ...
  description: 'Read expert articles on AI agents for Indian businesses, WhatsApp automation, chatbot development, web design, and growing your business with technology. By DigiAgentix.',
  keywords: [
  ...
  openGraph: {
    title: 'DigiAgentix Blog — AI, WhatsApp Automation & Web Design for Indian Businesses',
    description: 'Expert articles on AI agents, WhatsApp automation, chatbot development and web design for Indian businesses.',
    url: `${siteUrl}/blog`,
    type: 'website',
    images: [{ url: `${siteUrl}/logo.png`, width: 1200, height: 630, alt: 'DigiAgentix Blog' }],
  },
};
  ...
  blogPost: [
    {
      ...
      author: { '@type': 'Organization', name: 'DigiAgentix Team' },
